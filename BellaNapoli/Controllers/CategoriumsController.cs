...
namespace BellaNapoli.Controllers
{
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(TestDbventa1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,Descripcion,Estado,FechaRegistro")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategoria,Descripcion,Estado,FechaRegistro")] Categorium categorium)
        {
