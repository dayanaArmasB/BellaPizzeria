...
namespace BellaNapoli.Controllers
{
    public class DetalleComprasController : Controller
    {
        ...
        public DetalleComprasController(TestDbventa1Context context)
        {
            _context = context;
        }
        ...
        {
            var testDbventa1Context = _context.DetalleCompras.Include(d => d.IdCompraNavigation).Include(d => d.IdProductoNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdDetalleCompra,IdCompra,IdProducto,PrecioCompra,PrecioVenta,Cantidad,MontoTotal,FechaRegistro")] DetalleCompra detalleCompra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDetalleCompra,IdCompra,IdProducto,PrecioCompra,PrecioVenta,Cantidad,MontoTotal,FechaRegistro")] DetalleCompra detalleCompra)
        {
