...
-- Ejemplo 1: Pizza Margarita (con descripción acortada)
INSERT INTO PRODUCTO (Codigo, Nombre, Descripcion, IdCategoria, Stock, PrecioCompra, PrecioVenta, Estado, FechaRegistro)
VALUES ('PM001', 'Pizza Margarita', 'Pizza clásica con salsa de tomate' ,1, 50, 4.99, 9.99, 1, GETDATE());
...
INSERT INTO PRODUCTO (Codigo, Nombre, Descripcion, IdCategoria, Stock, PrecioCompra, PrecioVenta, Estado, FechaRegistro)
VALUES ('PV003', 'Pizza Vegetariana', 'Pizza con salsa de tomate, mozzarella, champiñones, pimientos y aceitunas',1, 30, 6.99, 13.99, 1, GETDATE());
...
INSERT INTO PRODUCTO (Codigo, Nombre, Descripcion, IdCategoria, Stock, PrecioCompra, PrecioVenta, Estado, FechaRegistro)
VALUES ('PV007', 'Pizza Hawaiana', 'Pizza con salsa de tomate, mozzarella, piña, jamon y pepperoni',1, 40, 5.99, 15.99, 1, GETDATE());

-- Ejemplo 8: Pizza 4 estaciones
INSERT INTO PRODUCTO (Codigo, Nombre, Descripcion, IdCategoria, Stock, PrecioCompra, PrecioVenta, Estado, FechaRegistro)
VALUES ('PV008', 'Pizza 4 estaciones', 'Pizza con salsa de tomate, mozzarella, champiñones, pimientos,jamon,salchicha italiana ,pepperoni,piñay aceitunas',1, 20, 8.99, 25.99, 1, GETDATE());

-- DATOS CLIENTES
INSERT INTO CLIENTE (Documento, NombreCompleto, Correo, Telefono, Estado, FechaRegistro)
VALUES
('12345678', 'Juan Pérez', 'juanperez@example.com', '987654321', 1, GETDATE()),
('23456789', 'María García', 'mariagarcia@example.com', '123456789', 1, GETDATE()),
('34567890', 'Pedro Ramírez', 'pedroramirez@example.com', '555555555', 1, GETDATE()),
('45678901', 'Ana López', 'analopez@example.com', '666666666', 1, GETDATE()),
('56789012', 'Carlos Martínez', 'carlosmartinez@example.com', '333333333', 1, GETDATE()),
('67890123', 'Laura Sánchez', 'laurasanchez@example.com', '999999999', 1, GETDATE()),
('78901234', 'Diego Rodríguez', 'diegorodriguez@example.com', '777777777', 1, GETDATE()),
('89012345', 'Sofía Hernández', 'sofiahernandez@example.com', '444444444', 1, GETDATE()),
('90123456', 'Luisa Gómez', 'luisagomez@example.com', '222222222', 1, GETDATE()),
